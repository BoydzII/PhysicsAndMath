  ...
  ch6_challenge: {
    ...
    problems: [
      // Easy: 1-15 (Basic Momentum, Impulse)
      {
        ...
        hints: `ใช้สูตร $p = mv$`,
        guide: `<div class="step">$p = 2 \\times 5 = 10$ kg m/s</div>`,
      ...
      },
      {
        ...
        hints: `แทนค่าใน $p = mv$`,
        guide: `<div class="step">$p = 1200 \\times 20 = 24000$ kg m/s</div>`,
      ...
      },
      {
        ...
        hints: `$v = \\frac{p}{m}$`,
        guide: `<div class="step">$v = \\frac{15}{0.5} = 30$ m/s</div>`,
      ...
      },
      {
        ...
        hints: `$m = \\frac{p}{v}$`,
        guide: `<div class="step">$m = \\frac{50}{10} = 5$ kg</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$I = 50 \\times 2 = 100$ N s</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$F = \\frac{120}{3} = 40$ N</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$I = 0.1(40 - 0) = 4$ N s</div>`,
        intermediateHtml: `I = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        hints: `$\\Delta p = m(v - u)$`,
        guide: `<div class="step">$\\Delta p = 2(2 - 10) = -16$ ขนาด = 16 kg m/s</div>`,
        intermediateHtml: `|\\Delta p| = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c9",
        text: `ถุงทรายมวล 5 kg ตกกระทบพื้นด้วยความเร็ว 8 m/s และหยุดนิ่งใน 0.2 s จงหาแรงกระแทกเฉลี่ย`,
        hints: `$F = \\frac{m(v - u)}{t}$`,
        guide: `<div class="step">$F = \\frac{5(0 - 8)}{0.2} = -200$ N (ขนาด 200 N)</div>`,
        intermediateHtml: `F = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$\\Delta v = \\frac{15 \\times 4}{3} = 20$ m/s</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$I = \\frac{1}{2} \\times 4 \\times 10 = 20$ N s</div>`,
        intermediateHtml: `I = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c13",
        text: `กระสุนปืน 0.05 kg ยิงออกจากปืน 5 kg ด้วยความเร็ว 400 m/s ความเร็วถอยหลังของปืนคือ?`,
        hints: `$m_1v_1 + m_2v_2 = 0$`,
        guide: `<div class="step">$v_2 = -\\frac{0.05 \\times 400}{5} = -4$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c14",
        text: `นก 0.2 kg บินด้วยความเร็ว 10 m/s ชนกระจกและกระดอนกลับด้วยความเร็ว 4 m/s หา $\\Delta p$`,
        hints: `ทิศตรงข้ามให้เป็นลบ`,
        guide: `<div class="step">$\\Delta p = 0.2(-4 - 10) = -2.8$ N s</div>`,
        intermediateHtml: `|\\Delta p| = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$10(2) = (10+40)v \\Rightarrow v = 0.4$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      ...
      {
        id: "ch6_c16",
        text: `รถ A (1000 kg) 20 m/s ชนรถ B (1500 kg) 10 m/s ทิศเดียวกัน หลังชนติดกันไป ความเร็วเป็นเท่าใด <br><svg width="200" height="60"><rect x="10" y="20" width="35" height="15" fill="red"/><rect x="80" y="20" width="35" height="15" fill="blue"/><line x1="50" y1="27" x2="70" y2="27" stroke="black"/></svg>`,
        hints: `ชนแบบไม่ยืดหยุ่นสมบูรณ์ (ติดกัน)`,
        guide: `<div class="step">$1000(20) + 1500(10) = 2500v \\Rightarrow v = 14$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c17",
        text: `รถ A (500 kg) 15 m/s ชนรถ B (500 kg) -5 m/s ชนแล้ว A หยุดนิ่ง ความเร็ว B? <br><svg width="200" height="60"><rect x="10" y="20" width="35" height="15" fill="red"/><rect x="120" y="20" width="35" height="15" fill="blue"/><line x1="50" y1="27" x2="110" y2="27" stroke="black"/></svg>`,
        hints: `อนุรักษ์โมเมนตัม`,
        guide: `<div class="step">$500(15) + 500(-5) = 500(0) + 500(v_B) \\Rightarrow v_B = 10$ m/s</div>`,
        intermediateHtml: `v_B = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c18",
        text: `วัตถุระเบิดออกเป็นสองส่วน ส่วนแรก 2 kg ไปทางซ้าย 10 m/s ส่วนที่สอง 4 kg ไปทางขวาเท่าใด <br><svg width="150" height="60"><circle cx="75" cy="30" r="15" fill="orange"/><path d="M75 30 L50 30 M75 30 L100 30" stroke="red"/></svg>`,
        hints: `โมเมนตัมเริ่มต้นเป็น 0`,
        guide: `<div class="step">$0 = 2(-10) + 4v \\Rightarrow v = 5$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
      ...
      },
      {
        ...
        guide: `<div class="step">$v_2 = \\frac{2m_1}{m_1+m_2}u_1 = \\frac{2(3)}{5}4 = 4.8$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c21",
        text: `รถบรรทุก 5000 kg 10 m/s ชนรถเก๋ง 1000 kg วิ่งสวนมา 20 m/s ติดกันไป หา v หลังชน <br><svg width="200" height="60"><rect x="10" y="20" width="50" height="20" fill="green"/><rect x="120" y="20" width="30" height="15" fill="purple"/></svg>`,
        hints: `ทิศสวนทางกัน v ต้องติดลบ`,
        guide: `<div class="step">$5000(10) + 1000(-20) = 6000v \\Rightarrow v = 5$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c22",
        text: `วัตถุระเบิดเป็น 3 ชิ้น ชิ้นแรก 1 kg ไปเหนือ 3 m/s ชิ้นสอง 1 kg ไปตะวันออก 4 m/s ชิ้นสาม 1 kg จะมีความเร็วเท่าใด <br><svg width="150" height="100"><circle cx="75" cy="50" r="10" fill="grey"/><line x1="75" y1="50" x2="75" y2="20" stroke="black"/><line x1="75" y1="50" x2="105" y2="50" stroke="black"/></svg>`,
        hints: `รวมแบบเวกเตอร์ $p_x$ และ $p_y$`,
        guide: `<div class="step">$p_3 = \\sqrt{3^2 + 4^2} = 5$ ดังนั้น $v = 5$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
      ...
      },
      {
        ...
        guide: `<div class="step">$0.01(300) = 0.01(100) + 2v \\Rightarrow v = 1$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c25",
        text: `รถ 2000 kg ชนกำแพงด้วยความเร็ว 15 m/s และเด้งกลับด้วยความเร็ว 5 m/s ใน 0.1 s แรงเฉลี่ยคือ? <br><svg width="150" height="60"><rect x="30" y="20" width="40" height="20" fill="red"/><rect x="100" y="10" width="10" height="40" fill="gray"/></svg>`,
        hints: `$F = \\frac{m(v-u)}{t}$`,
        guide: `<div class="step">$F = \\frac{2000(-5 - 15)}{0.1} = -400000$ N</div>`,
        intermediateHtml: `|F| = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c26",
        text: `นักบินอวกาศ 80 kg ขว้างประแจ 2 kg ด้วยความเร็ว 10 m/s นักบินจะถอยหลังด้วยความเร็วเท่าใด`,
        hints: `โมเมนตัมรวม = 0`,
        guide: `<div class="step">$0 = 80v + 2(10) \\Rightarrow v = -0.25$ m/s</div>`,
        intermediateHtml: `|v| = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$u=10, v=-8 \\Rightarrow I = 0.2(-8 - 10) = -3.6$ N s</div>`,
        intermediateHtml: `|I| = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$v_p = 2$ m/s $\\Rightarrow \\frac{1}{2}(1000)(2^2) = f(1) \\Rightarrow f = 2000$ N</div>`,
        intermediateHtml: `f = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c29",
        text: `กล่อง 4 kg 5 m/s ชนกล่อง 6 kg ที่อยู่นิ่ง หลังชนกล่อง 4 kg สะท้อนกลับ 1 m/s กล่อง 6 kg เร็วเท่าใด <br><svg width="200" height="60"><rect x="20" y="20" width="30" height="20" fill="yellow" stroke="black"/><rect x="100" y="20" width="30" height="20" fill="brown" stroke="black"/></svg>`,
        hints: `$m_1u_1 = m_1v_1 + m_2v_2$`,
        guide: `<div class="step">$4(5) = 4(-1) + 6v \\Rightarrow 20 = -4 + 6v \\Rightarrow v = 4$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
      ...
      // Hard: 31-40 (Applied, Mixed Concepts)
      {
        ...
        guide: `<div class="step">$V = \\sqrt{2(10)(0.05)} = 1$ m/s, $0.02u = 2(1) \\Rightarrow u = 100$ m/s</div>`,
        intermediateHtml: `u = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        id: "ch6_c32",
        text: `รถ A 1000 kg ไปตะวันออก 15 m/s ชนรถ B 2000 kg ไปเหนือ 10 m/s ติดกันไป หา v หลังชน <br><svg width="150" height="150"><rect x="20" y="70" width="30" height="15" fill="red"/><rect x="70" y="110" width="15" height="30" fill="blue"/></svg>`,
        hints: `รวม $p$ แบบเวกเตอร์ $p = \\sqrt{p_x^2 + p_y^2}$`,
        guide: `<div class="step">$p_x = 15000, p_y = 20000 \\Rightarrow p_{tot} = 25000 \\Rightarrow v = \\frac{25000}{3000} = 8.33$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$p^2 = 2(2)(18) = 72 \\Rightarrow E_{k2} = \\frac{72}{2(3)} = 12$ J</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$F = 1000 \\times (0.05 \\times 10^{-3}) \\times 10 = 0.5$ N</div>`,
        intermediateHtml: `F = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        guide: `<div class="step">$\\frac{m-M}{m+M} = -0.5 \\Rightarrow M = 3m \\Rightarrow M/m = 3$</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$H = \\frac{V^2}{2g} = \\frac{(u/3)^2}{2g} = \\frac{h}{9}$</div>`,
      ...
      },
      {
        ...
        guide: `<div class="step">$0 = 50(1.2 - v) - 10v \\Rightarrow 60 = 60v \\Rightarrow v = 1$ m/s</div>`,
        intermediateHtml: `v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
        ...
        hints: `$I = m\\Delta v$`,
        guide: `<div class="step">ที่ t=3, $I = 36$ N s $\\Rightarrow \\Delta v = 36/2 = 18$ m/s</div>`,
        intermediateHtml: `\\Delta v = <input type="text" class="answer-input">`,
        advancedHtml: `<input type="text" class="answer-input">`
      },
      {
