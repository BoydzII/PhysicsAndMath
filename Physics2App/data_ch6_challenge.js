...
Object.assign(physicsData.topics, {
  ...
  \\end{aligned}$$</div>`,
      ...
      {
        id: "ch6_c11",
        text: `รถยนต์ A (1000 kg) ความเร็ว 15 m/s ชนรถยนต์ B (1000 kg) ที่อยู่นิ่ง แล้วชนติดกันไป ความเร็วหลังชนเป็นเท่าใด <br><svg width="200" height="60"><rect x="20" y="20" width="40" height="20" fill="red"/><rect x="120" y="20" width="40" height="20" fill="blue"/><line x1="65" y1="30" x2="110" y2="30" stroke="black"/></svg>`,
  ...
  \\end{aligned}$$</div>`,
      ...
      {
        id: "ch6_c25",
        text: `รถ 2000 kg ชนกำแพงด้วยความเร็ว 15 m/s และเด้งกลับด้วยความเร็ว 5 m/s ใน 0.1 s จงหาขนาดแรงเฉลี่ย <br><svg width="150" height="60"><rect x="30" y="20" width="40" height="20" fill="red"/><rect x="100" y="10" width="10" height="40" fill="gray"/></svg>`,
        hints: `$F = \\frac{m(v-u)}{t}$`,
        guide: `<div class="step">$$\\begin{aligned}
  ...
  \\end{aligned}$$</div>`,
      ...
      {
        id: "ch6_c40",
        text: `ลูกบอลมวล 0.5 kg วิ่งชนกำแพงทำมุม $60^\\circ$ กับเส้นตั้งฉาก สะท้อนกลับมุมเดิม อัตราเร็ว 10 m/s จงหาขนาดการดล (กำหนด $\\cos 60^\\circ = 0.5$) <br><svg width="150" height="150"><rect x="100" y="20" width="10" height="100" fill="gray"/><line x1="30" y1="40" x2="90" y2="70" stroke="black"/><line x1="90" y1="70" x2="30" y2="100" stroke="black"/></svg>`,
