const physicsData = {
  topics: {
    work: {
      ...
      title: "5.1 งาน",
      theory: `
      <h2><span class="t-num">5.1</span>งาน (Work)</h2><p class="lead">งานเกิดจากการ<b>ดอท</b>เวกเตอร์แรงกับเวกเตอร์การกระจัด ผลลัพธ์จึงเป็น<b>ปริมาณสเกลาร์</b> — มีขนาดและเครื่องหมาย แต่ไม่มีทิศ</p><section class="eq-core"><div class="eq-label">สมการตั้งต้น <span>· ดอทของเวกเตอร์</span></div><div class="eq-block">$$\\begin{aligned}W &= \\vec F\\cdot\\vec s \\\\ &= Fs\\cos\\theta \\\\ &= F_x s_x + F_y s_y\\end{aligned}$$</div><ol class="derive"><li><p>ใช้เฉพาะส่วนของแรงที่อยู่ใน<b>แนวการกระจัด</b></p><div class="eq-block">$$W = (F\\cos\\theta)\\,s$$</div></li><li><p>มุม $\\theta$ ระหว่าง $\\vec F$ กับ $\\vec s$ บอกเครื่องหมายของงาน<span class="signs"><span class="pos">$\\theta<90^\\circ$ งานบวก</span><span class="zero">$\\theta=90^\\circ$ งานเป็นศูนย์</span><span class="neg">$\\theta>90^\\circ$ งานลบ</span></span></p></li><li><p>หน่วย $\\text{N}\\cdot\\text{m}$ = จูล ($\\text{J}$)</p></li></ol></section><h3 class="eq-sec">สมการหลักที่ใช้บ่อย</h3><div class="eq-list"><div class="eq-row vec"><div class="eq-name">ทบทวน: ดอทของเวกเตอร์</div><div class="eq-block">$$\\begin{aligned}\\vec A\\cdot\\vec B &= AB\\cos\\theta \\\\ &= A_xB_x + A_yB_y\\end{aligned}$$</div></div><div class="eq-row vec"><div class="eq-name">เวกเตอร์ตั้งฉากกัน</div><div class="eq-block">$$\\vec A\\perp\\vec B \\;\\Rightarrow\\; \\vec A\\cdot\\vec B = 0$$</div></div><div class="eq-row"><div class="eq-name">งานของแรงเสียดทาน</div><div class="eq-block">$$\\begin{aligned}W_f &= \\vec f\\cdot\\vec s \\\\ &= fs\\cos180^\\circ \\\\ &= -fs\\end{aligned}$$</div></div><div class="eq-row"><div class="eq-name">งานของแรงโน้มถ่วง</div><div class="eq-block">$$\\begin{aligned}W_{mg} &= m\\vec g\\cdot\\vec s \\\\ &= -mg\\,\\Delta h\\end{aligned}$$</div></div><div class="eq-row"><div class="eq-name">งานของแรงสปริง</div><div class="eq-block">$$W_s = -\\left(\\tfrac12 kx_2^2 - \\tfrac12 kx_1^2\\right)$$</div></div><div class="eq-row"><div class="eq-name">แรงไม่คงตัว</div><div class="eq-block">$$W = \\text{พื้นที่ใต้กราฟ } F\\text{–}s$$</div></div><div class="eq-row"><div class="eq-name">งานลัพธ์</div><div class="eq-block">$$\\begin{aligned}W_{net} &= \\textstyle\\sum W_i \\\\ &= \\vec F_{net}\\cdot\\vec s\\end{aligned}$$</div></div></div><aside class="tips"><div class="tips-title">จำให้ขึ้นใจ</div><ul><li>แบกของเดินแนวราบ แรงแบกตั้งฉากกับการกระจัด → <b>ไม่มีงาน</b></li><li>แรงแนวฉาก $\\vec N$ ตั้งฉากกับพื้นเสมอ จึงไม่ทำงานเมื่อวัตถุเลื่อนบนพื้น</li></ul></aside><div class="sim-title">🎮 ลองเล่น: ดอทแรงกับการกระจัด <span class="badge">ภารกิจ</span></div><canvas id="simWork" class="sim-canvas"></canvas>
    `,
      problems: [
        {
          id: "w1",
    ...
    kinetic: {
      ...
      theory: `
      <h2><span class="t-num">5.3</span>พลังงานจลน์ (Kinetic Energy)</h2><p class="lead">พลังงานจลน์คือพลังงานของวัตถุที่<b>กำลังเคลื่อนที่</b> และเชื่อมกับงานผ่าน<b>ทฤษฎีบทงาน–พลังงาน</b></p><section class="eq-core"><div class="eq-label">สมการตั้งต้น <span>· ดอทของเวกเตอร์</span></div><div class="eq-block">$$\\begin{aligned}W_{net} &= \\vec F_{net}\\cdot\\vec s \\\\ &= \\tfrac12 mv^2 - \\tfrac12 mu^2 \\\\ &= \\Delta E_k\\end{aligned}$$</div><ol class="derive"><li><p>เริ่มจากกฎข้อสอง แล้วดอทด้วย $\\vec s$ ทั้งสองข้าง</p><div class="eq-block">$$\\vec F_{net}\\cdot\\vec s = m\\,\\vec a\\cdot\\vec s$$</div></li><li><p>สมการการเคลื่อนที่แบบเวกเตอร์ให้</p><div class="eq-block">$$\\vec a\\cdot\\vec s = \\tfrac12\\left(v^2 - u^2\\right)$$</div></li><li><p>แทนค่ากลับ</p><div class="eq-block">$$W_{net} = \\tfrac12 mv^2 - \\tfrac12 mu^2$$</div></li></ol></section><h3 class="eq-sec">สมการหลักที่ใช้บ่อย</h3><div class="eq-list"><div class="eq-row"><div class="eq-name">พลังงานจลน์</div><div class="eq-block">$$\\begin{aligned}E_k &= \\tfrac12 m\\,\\vec v\\cdot\\vec v \\\\ &= \\tfrac12 mv^2\\end{aligned}$$</div></div><div class="eq-row vec"><div class="eq-name">สมการการเคลื่อนที่ (เวกเตอร์)</div><div class="eq-block">$$v^2 = u^2 + 2\\,\\vec a\\cdot\\vec s$$</div></div><div class="eq-row"><div class="eq-name">แรงคงตัวทำงานระยะ s</div><div class="eq-block">$$Fs\\cos\\theta = \\tfrac12 mv^2 - \\tfrac12 mu^2$$</div></div><div class="eq-row"><div class="eq-name">เชื่อมกับโมเมนตัม</div><div class="eq-block">$$E_k = \\frac{p^2}{2m}$$</div></div><div class="eq-row"><div class="eq-name">เบรกจนหยุด</div><div class="eq-block">$$-fs = 0 - \\tfrac12 mu^2$$</div></div></div><aside class="tips"><div class="tips-title">จำให้ขึ้นใจ</div><ul><li>$E_k$ เป็นสเกลาร์และ<b>ไม่ติดลบ</b> ทิศของความเร็วไม่มีผล</li><li>ความเร็วเพิ่ม 2 เท่า → พลังงานจลน์เพิ่ม <b>4 เท่า</b></li></ul></aside><div class="sim-title">🎮 ลองเล่น: ดันรถแล้ววัดความเร็ว <span class="badge">ภารกิจ</span></div><canvas id="simKinetic" class="sim-canvas"></canvas>
    `,
      problems: [
        {
          id: "ke1",
    ...
    potential: {
      ...
      theory: `
      <h2><span class="t-num">5.4</span>พลังงานศักย์ (Potential Energy)</h2><p class="lead">พลังงานศักย์คือพลังงานที่สะสมตาม<b>ตำแหน่ง</b> เกิดจากแรงอนุรักษ์ เช่น แรงโน้มถ่วงและแรงสปริง</p><section class="eq-core"><div class="eq-label">สมการตั้งต้น <span>· ดอทของเวกเตอร์</span></div><div class="eq-block">$$\\begin{aligned}\\Delta E_p &= -W_c \\\\ &= -m\\vec g\\cdot\\Delta\\vec s \\\\ &= mg\\,\\Delta h\\end{aligned}$$</div><ol class="derive"><li><p>ให้ $\\vec g$ ชี้ลง และการกระจัดมีทั้งแนวราบและแนวดิ่ง</p><div class="eq-block">$$\\begin{aligned}\\vec g &= -g\\,\\hat j \\\\ \\Delta\\vec s &= \\Delta x\\,\\hat i + \\Delta h\\,\\hat j\\end{aligned}$$</div></li><li><p>ดอทแล้วเหลือแค่แนวดิ่ง — งาน<b>ไม่ขึ้นกับเส้นทาง</b></p><div class="eq-block">$$m\\vec g\\cdot\\Delta\\vec s = -mg\\,\\Delta h$$</div></li><li><p>จึงนิยาม ($h$ วัดจากระดับอ้างอิงที่เลือกเอง)</p><div class="eq-block">$$E_p = mgh$$</div></li></ol></section><h3 class="eq-sec">สมการหลักที่ใช้บ่อย</h3><div class="eq-list"><div class="eq-row"><div class="eq-name">ศักย์โน้มถ่วง</div><div class="eq-block">$$E_p = mgh$$</div></div><div class="eq-row"><div class="eq-name">ศักย์ยืดหยุ่น</div><div class="eq-block">$$E_p = \\tfrac12 kx^2$$</div></div><div class="eq-row vec"><div class="eq-name">กฎของฮุก</div><div class="eq-block">$$\\vec F = -k\\vec x$$</div></div><div class="eq-row vec"><div class="eq-name">งานของแรงอนุรักษ์</div><div class="eq-block">$$W_c = -\\Delta E_p$$</div></div><div class="eq-row"><div class="eq-name">พื้นที่ใต้กราฟ F–x</div><div class="eq-block">$$\\begin{aligned}\\text{พื้นที่} &= \\tfrac12 (kx)(x) \\\\ &= \\tfrac12 kx^2\\end{aligned}$$</div></div><div class="eq-row"><div class="eq-name">งานที่คนทำเมื่อยกช้า ๆ</div><div class="eq-block">$$W_{\\text{คน}} = +mg\\,\\Delta h$$</div></div></div><aside class="tips"><div class="tips-title">จำให้ขึ้นใจ</div><ul><li>ต่ำกว่าระดับอ้างอิง $h$ ติดลบ → $E_p$ <b>ติดลบได้</b></li><li>วัตถุตก: $\\vec g$ ทิศเดียวกับ $\\Delta\\vec s$ แรงโน้มถ่วงทำงานบวก $E_p$ จึงลดลง</li></ul></aside><div class="sim-title">🎮 ลองเล่น: ระดับอ้างอิงและสปริง <span class="badge">ลาก/ปล่อย</span></div><canvas id="simPotential" class="sim-canvas"></canvas>
    `,
      problems: [
        {
          id: "pe1",
    ...
    conservation: {
      ...
      theory: `
      <h2><span class="t-num">5.5</span>กฎการอนุรักษ์พลังงานกล</h2><p class="lead">พลังงานกล $E = E_k + E_p$ <b>คงตัว</b> เมื่อไม่มีแรงไม่อนุรักษ์ทำงาน เช่น แรงเสียดทาน แรงต้านอากาศ</p><section class="eq-core"><div class="eq-label">สมการตั้งต้น <span>· ดอทของเวกเตอร์</span></div><div class="eq-block">$$\\begin{aligned}E_{k1} + E_{p1} + W_{nc} &= E_{k2} + E_{p2} \\\\ W_{nc} &= \\textstyle\\sum \\vec F_{nc}\\cdot\\vec s\\end{aligned}$$</div><ol class="derive"><li><p>งานลัพธ์แยกเป็นงานของแรงอนุรักษ์กับแรงไม่อนุรักษ์</p><div class="eq-block">$$W_c + W_{nc} = \\Delta E_k$$</div></li><li><p>แทน $W_c = -\\Delta E_p$</p><div class="eq-block">$$W_{nc} = \\Delta E_k + \\Delta E_p$$</div></li><li><p>ถ้า $W_{nc} = 0$ พลังงานกลคงตัว</p><div class="eq-block">$$E_{k1} + E_{p1} = E_{k2} + E_{p2}$$</div></li></ol></section><h3 class="eq-sec">สมการหลักที่ใช้บ่อย</h3><div class="eq-list"><div class="eq-row"><div class="eq-name">ไม่มีแรงเสียดทาน</div><div class="eq-block">$$\\begin{aligned}&\\tfrac12 mv_1^2 + mgh_1 \\\\ &= \\tfrac12 mv_2^2 + mgh_2\\end{aligned}$$</div></div><div class="eq-row"><div class="eq-name">มีสปริงร่วมด้วย</div><div class="eq-block">$$\\tfrac12 mv^2 + mgh + \\tfrac12 kx^2 = \\text{คงตัว}$$</div></div><div class="eq-row warn"><div class="eq-name">มีแรงเสียดทาน</div><div class="eq-block">$$E_1 - fs = E_2$$</div></div><div class="eq-row"><div class="eq-name">ตกจากที่สูง h (เริ่มจากหยุดนิ่ง)</div><div class="eq-block">$$v = \\sqrt{2gh}$$</div></div><div class="eq-row vec"><div class="eq-name">แรงตั้งฉากไม่ทำงาน</div><div class="eq-block">$$\\begin{aligned}\\vec N\\cdot\\vec v &= 0 \\\\ \\vec T\\cdot\\vec v &= 0\\end{aligned}$$</div></div></div><aside class="tips"><div class="tips-title">จำให้ขึ้นใจ</div><ul><li>แรงตึงเชือกและแรงแนวฉาก<b>ตั้งฉากกับการเคลื่อนที่</b> จึงไม่ทำงาน พลังงานกลยังคงตัวแม้ทางโค้ง</li><li>แรงเสียดทานทำงาน $-fs$ พลังงานกลส่วนนี้กลายเป็น<b>ความร้อน</b></li></ul></aside><div class="sim-title">🎮 ลองเล่น: ลานสเก็ต <span class="badge">ภารกิจราง W</span></div><canvas id="simConservation" class="sim-canvas"></canvas>
    `,
      problems: [
        {
          id: "ce1",
